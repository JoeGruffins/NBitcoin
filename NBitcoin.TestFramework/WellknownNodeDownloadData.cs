...
namespace NBitcoin.Tests
{
 ...
 : NodeDownloadDataBase
		...
		public class DecredNodeDownloadData
 : NodeDownloadDataBase
		{
			public NodeDownloadData v2_0_6 = new NodeDownloadData()
			{
				Version = "2.0.6",
				Windows = new NodeOSDownloadData()
				{
		...
		public static DecredNodeDownloadData Decred
		{
			get; set;
		} = new DecredNodeDownloadData();

		public bool UseSectionInConfigFile { get; private set; }
		public string AdditionalRegtestConfig { get; private set; }
		public bool IsDecred { get; private set; }
	}
}
